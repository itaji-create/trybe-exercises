...
// cada pessoa contratada em seu respectivo id . A sua função deve receber 
// como parâmetro o nome completo da pessoa funcionária e a partir dele gerar 
...
const megaDaVirada = (myNumber) => {
  const number = Math.floor((Math.random() * 5) + 1);
  return myNumber === number ? 'Lucky day, you won!' : 'Try Again!';
};
// console.log(megaDaVirada(3))
...
//     da pessoa estudante) e o terceiro é uma função que checa se a resposta está correta 
//     e faz a contagem da pontuação final recebida pela pessoa estudante. Ao final a HOF 
